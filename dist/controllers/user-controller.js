...
var user = db_1.CURRENT_USER;
var UserController = /** @class */ (function () {
    function UserController() {
        this.authenticateUser = passport_1.default.authenticate('local', {
            successRedirect: '/',
    ...
    UserController.prototype.formLogIn = function (req, res) {
        var error = res.locals.message.error;
        res.render('logIn', {
    ...
    UserController.prototype.createAccountDB = function (req, res) {
